        ...
        <div className="bg-white border-b border-[#E2E8F0] px-4 md:px-8 py-3 md:py-4 sticky top-0 z-10">
          <div className="flex items-center gap-3 mb-3 md:mb-0">
            ...
            <div className="min-w-0 pl-1 md:pl-0">
              ...
              <div className="text-xs text-slate-400 truncate hidden sm:block">AI-ranked candidates for each job</div>
            </div>
          </div>
          <button
            onClick={() => downloadCandidatesExcel(matched, `${job?.title}_Matches`)}
            className="flex items-center gap-2 bg-[#10B981] text-white px-4 py-2 rounded-xl text-sm font-semibold hover:bg-[#059669] transition-all w-full md:w-auto justify-center">
                ...
                <div key={i} className="bg-white rounded-2xl border border-[#E2E8F0] p-4">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-slate-400 truncate">{c.edu}</div>
                    </div>
          ...
          <div className="hidden md:block bg-white rounded-2xl border border-[#E2E8F0] overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {matched.map((c,i) => (
                    <tr key={i} className={`border-b border-[#F1F5F9] hover:bg-[#F8FAFC] transition-all ${i<3?"bg-yellow-50/20":""}`}>
                      ...
                      <td className="py-3 px-3">
                        <span className="text-xs bg-[#F5F3FF] text-[#8B5CF6] px-2 py-1 rounded-lg whitespace-nowrap">
                          {c.qualification}
                        </span>
                      </td>
                      <td className="py-3 px-3">
            ...
            <div className="p-4 md:p-6">
              <div className="flex flex-wrap items-center gap-4 mb-5 p-4 bg-[#F8FAFC] rounded-xl">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-sm text-slate-400 truncate">{selected.role}</div>
