    ...
    <div className="min-h-screen flex bg-[#F0F4FA]">
      ...
      <div className="ml-0 md:ml-0 md:ml-56 flex-1">
        ...
        <div className="bg-white border-b border-[#E2E8F0] px-8 py-4 flex items-center justify-between sticky top-0 z-10">
          <div>
            <div className="text-lg font-bold text-[#1E293B]">Analytics</div>
            <div className="text-xs text-slate-400">Recruitment insights and performance metrics</div>
          </div>
            ...
            {[
              ...
              return (
                <div key={i} className="bg-white rounded-2xl border border-[#E2E8F0] p-5">
                  ...
                  <div className="text-3xl font-bold text-[#1E293B] mb-1">{s.val}</div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
                  <div className="font-bold text-[#1E293B] mb-5">📈 Weekly Resume Activity</div>
                  <ResponsiveContainer width="100%" height={220}>
                    <AreaChart data={ANALYTICS.weekly}>
                      ...
                      <Legend/>
                      <Area type="monotone" dataKey="resumes" name="Resumes Uploaded"
                        stroke="#0EA5C9" fill="url(#g1)" strokeWidth={2.5}/>
                      <Area type="monotone" dataKey="shortlisted" name="Shortlisted"
                        stroke="#10B981" fill="url(#g2)" strokeWidth={2.5}/>
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
                ...
                {/* Hiring Funnel */}
                <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
                  <div className="font-bold text-[#1E293B] mb-5">🔽 Hiring Funnel</div>
                  <ResponsiveContainer width="100%" height={220}>
                    <BarChart data={ANALYTICS.funnel} layout="vertical" margin={{ left:10, right:30 }}>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                {/* Department Pie */}
                <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
                  <div className="font-bold text-[#1E293B] mb-5">🏢 Applications by Department</div>
                  <div className="flex items-center gap-6">
                    <ResponsiveContainer width="55%" height={200}>
                      <PieChart>
                        <Pie data={ANALYTICS.dept} dataKey="value" cx="50%" cy="50%"
                ...
                {/* Time to Hire */}
                <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
                  <div className="font-bold text-[#1E293B] mb-5">⏱️ Avg Time to Hire (Days)</div>
                  <ResponsiveContainer width="100%" height={200}>
                    <LineChart data={timeToHire}>
                      <XAxis dataKey="month" tick={{ fontSize:11, fill:"#94A3B8" }} axisLine={false} tickLine={false}/>
                      <YAxis hide/>
                      <Tooltip contentStyle={{ borderRadius:12, border:"1px solid #E2E8F0", fontSize:12 }}/>
                      <Line type="monotone" dataKey="days" stroke="#1253A4"
                        strokeWidth={3} dot={{ fill:"#1253A4", r:5 }} name="Days"/>
                    </LineChart>
                  </ResponsiveContainer>
                  <div className="mt-3 flex items-center gap-2 text-xs text-green-600 font-semibold">
                    ↓ 50% reduction in time to hire over 6 months
                  </div>
                </div>
              </div>
            </div>
          ...
          {activeTab === "Candidates" && (
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-6">
                ...
                {/* Score Distribution */}
                <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
                  <div className="font-bold text-[#1E293B] mb-5">🎯 Score Distribution</div>
                  <ResponsiveContainer width="100%" height={220}>
                ...
                {/* Status Breakdown */}
                <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
                  <div className="font-bold text-[#1E293B] mb-5">📊 Candidate Status Breakdown</div>
                  {[
                      ...
                      <div className="flex-1">
                        ...
                        <div className="h-1.5 bg-[#E2E8F0] rounded-full mt-1 overflow-hidden">
                          <div className="h-full rounded-full transition-all"
                            style={{ width:`${(s.count/CANDIDATES.length)*100}%`, background:s.color }}/>
                        </div>
                      </div>
                      <div className="text-xs font-bold text-slate-400">
                        {Math.round((s.count/CANDIDATES.length)*100)}%
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="font-bold text-[#1E293B]">👥 Top Candidates Summary</div>
                  <button onClick={() => router.push("/hr/candidates")}
                    className="text-xs text-[#1253A4] font-semibold hover:underline">
                    View All →
                  </button>
                </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-3 gap-4 mb-2">
                {[
                  ...
                  <div key={i} className="bg-white rounded-2xl border border-[#E2E8F0] p-5 text-center">
              ...
              {/* Jobs performance */}
              <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
                <div className="font-bold text-[#1E293B] mb-5">💼 Job Performance</div>
                <ResponsiveContainer width="100%" height={250}>
                  <BarChart data={JOBS} margin={{ left:0, right:20 }}>
                    <XAxis dataKey="title"
                    ...
                    <Legend/>
                    <Bar dataKey="matches"    name="Total Matches"   fill="#1253A4" radius={[4,4,0,0]}/>
              ...
              {/* Jobs table */}
              <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
                <div className="font-bold text-[#1E293B] mb-4">📋 All Jobs Summary</div>
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-[#F1F5F9]">
          ...
          {activeTab === "Skills" && (
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
                  <div className="font-bold text-[#1E293B] mb-5">🔧 Top Skills in Candidate Pool</div>
                  <ResponsiveContainer width="100%" height={250}>
                ...
                {/* Skill demand */}
                <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
                  <div className="font-bold text-[#1E293B] mb-5">📊 Skill Demand vs Supply</div>
                      ...
                      return (
                        <div key={i}>
                          <div className="flex justify-between text-xs mb-1">
                            ...
                            <span className="text-slate-400">Supply {s.value}% · Demand {demand}%</span>
                          </div>
              ...
              {/* Skills gap */}
              <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
                <div className="font-bold text-[#1E293B] mb-4">⚠️ Skills Gap Analysis</div>
